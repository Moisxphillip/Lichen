...
Attack::Attack(GameObject& Parent, AttackData Data, CollisionMask Target, float LifeTime, float AfterHitLifeTime)
: Component(Parent), Data(Data), _LifeTime(LifeTime), _AfterHitLifeTime(AfterHitLifeTime)
{
